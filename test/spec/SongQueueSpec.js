describe('SongQueue', function() {
  ...
  describe('when a song is dequeued', function() {
    it('removes the song with shift', function() {
      shiftSpy = sinon.spy(SongQueue.prototype, 'shift');
      var songQueue = new SongQueue(songData1);
      songQueue.at(0).dequeue();
      expect(shiftSpy).to.have.been.called;
      SongQueue.prototype.shift.restore();
    });
  });
